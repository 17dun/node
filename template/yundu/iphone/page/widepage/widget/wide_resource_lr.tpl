{[%strip%]}
    ...
    {[%if !empty($item.resource_image)%]}
        ...
        {[%if $item.resource_image.data_value.width == $item.resource_image.data_value.height%]}
            {[%if !empty($item.resource_image.data_value.href)%]}
            <a class="resource-img-link" href="{[%$item.resource_image.data_value.href%]}">
                <img class="resource-img resource-icon" data-src="{[%$item.resource_image.data_value.src|regex_replace:"/.{1}tpl_size.{1}/g":"b640_640"%]}" wrap="a" data-width="{[%$item.resource_image.data_value.width%]}" data-height="{[%$item.resource_image.data_value.height%]}"/>
            </a>
            {[%else%]}
                <img class="resource-img resource-icon" data-src="{[%$item.resource_image.data_value.src|regex_replace:"/.{1}tpl_size.{1}/g":"b640_640"%]}" wrap="a" data-width="{[%$item.resource_image.data_value.width%]}" data-height="{[%$item.resource_image.data_value.height%]}"/>
            {[%/if%]}
        {[%else%]}
            {[%if !empty($item.resource_image.data_value.href)%]}
            <a class="resource-img-link" href="{[%$item.resource_image.data_value.href%]}">
                <img class="resource-img" data-src="{[%$item.resource_image.data_value.src|regex_replace:"/.{1}tpl_size.{1}/g":"b640_640"%]}" wrap="a" data-width="{[%$item.resource_image.data_value.width%]}" data-height="{[%$item.resource_image.data_value.height%]}"/>
            </a>
            {[%else%]}
                <img class="resource-img" data-src="{[%$item.resource_image.data_value.src|regex_replace:"/.{1}tpl_size.{1}/g":"b640_640"%]}" data-width="{[%$item.resource_image.data_value.width%]}" data-height="{[%$item.resource_image.data_value.height%]}"/>
            {[%/if%]}
        {[%/if%]}
    ...
    {[%foreach name=normal_list from=$item.resource_normal item=normal%]}
        ...
        {[%elseif $struct.type == "RESOURCE_NORMAL_IMG"%]}
            ...
            <a href="{[%$struct.data_value.href%]}"><img data-width="{[%$struct.data_value.width%]}" data-height="{[%$struct.data_value.height%]}" data-src="{[%$struct.data_value.src|regex_replace:"/.{1}tpl_size.{1}/g":"b640_640"%]}" wrap="a"/></a>
            {[%else%]}
