...
{[%elseif $item.type eq "ABSTRACT"%]}
	{[%include file="tpl/summary.soy" sub_data=$item.data_value%]}
{[%elseif $item.type eq "VIRTUAL_CONTENT_TEXT"%]}
	{[%include file="./wide_virtual_content.tpl" sub_data=$item.data_value%]}
{[%/if%]}
