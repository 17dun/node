...
describe('prepro',function(){
    describe('#prepro_copyright',function(){
        it('the pos of data-ad-type=COPYRIGHT should be 32',function(done){

            fs.readFile('./app/tcwise/test/data/copyright.txt', function (err, block) {
                if (err) throw err;
                //console.log(data);
                var res = {
              ...
              //  console.log(JSON.parse(block));
                ...
                cpredata.prepro_copyright(block, res ,function(err, data){
                   // console.log(res);
                    ...
                    res.page_ad += "</div>";
                    assert.equal(32,res.page_ad.search(/data-ad-type=COPYRIGHT/));
                    done();
