...
describe('prepro',function(){
    describe('#prepro_topsearch1',function(){
        it('the type of data-ad-type=COPYRIGHT_STRUCT should be COPY_RIGHT',function(done){

            fs.readFile('./app/tcwise/test/data/topsearch1.txt', function (err, block) {
                if (err) throw err;
                //console.log(data);
                var res = {
              ...
              //console.log(block);
                ...
                predata.prepro_topsearch1(block, res ,function(err, data){
                   //console.log(res);
                    ...
                    //res.page_ad += "</div>";
                    assert.equal(1,res.top_search.search_type);
                    done();
