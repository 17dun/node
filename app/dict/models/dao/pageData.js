    ...
    retry_http_request(http_options,function(err,mcpack_data,riglog){
        ...
        if(err != null){
            callback(err);
             ...
             //mcpack
            var dataMcpack = mcpack.mcpackbuf_2_object(mcpack_data);
        	try{
        		var data = JSON.parse(dataMcpack['struct_data']);
        		//var data = dataMcpack['struct_data'];
        		var page_data= data;
        	}catch(e){
        		callback(e);
                return;
